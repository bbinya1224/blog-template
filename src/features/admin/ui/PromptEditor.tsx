        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='p-6'>
            ...
            <textarea
              ...
              className='h-96 w-full rounded-md border border-gray-300 p-3 font-mono text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none'
