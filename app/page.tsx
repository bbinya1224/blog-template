        ...
        <section className='relative overflow-hidden px-6 pb-20 pt-16 md:pt-32'>
          <div className='mx-auto max-w-4xl text-center animate-fade-in-up'>
            ...
            <div className='flex flex-col items-center justify-center gap-4 sm:flex-row'>
              <button
                onClick={() => signIn('google')}
                className='group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-2xl bg-blue-600 px-8 py-4 text-xl font-bold text-white shadow-xl transition-all hover:bg-blue-700 hover:shadow-2xl active:scale-95 sm:w-auto'
              >
              ...
              <a
                ...
                target='_blank'
                rel='noreferrer'
                className='w-full rounded-2xl bg-gray-100 px-8 py-4 text-lg font-bold text-gray-700 transition hover:bg-gray-200 active:scale-95 sm:w-auto'
              >
            ...
            <div className='grid gap-8 md:grid-cols-2'>
              ...
              <div className='rounded-3xl bg-blue-600 p-8 shadow-xl transition transform md:scale-105 md:p-12'>
                ...
                <ul className='space-y-3 text-lg text-blue-100'>
                  <li className='flex items-center gap-2'>
                    <span className='rounded-full bg-blue-500 p-1 text-xs text-white'>
                      ✓
                    </span>
                    경험(메모)만 입력하면 끝
                  </li>
          ...
          <div className='mx-auto max-w-5xl'>
            ...
            <div className='grid gap-6 md:grid-cols-3'>
              {[
                ...
                <div
                  key={idx}
                  className='group rounded-3xl border border-gray-100 bg-white p-8 transition hover:border-blue-100 hover:bg-blue-50/50 hover:shadow-lg'
                >
          ...
          <div className='mx-auto max-w-3xl'>
            ...
            <div className='space-y-4'>
              {FAQ_ITEMS.map((item, i) => (
                <div
                  key={i}
                  className='rounded-2xl border border-gray-100 bg-gray-50 p-6 transition hover:bg-white hover:shadow-md'
                >
      ...
      <footer className='border-t border-gray-100 bg-white py-12'>
        <div className='container mx-auto px-6 text-center text-gray-400'>
          <p className='mb-2 text-sm'>
            © 2025 BlogToneLab. All rights reserved.
          </p>
          <p className='mb-4 text-sm hover:text-amber-500'>
            <a href='https://bbinya1224.github.io/blog' target='_blank'>
              Bbinya&apos;s Blog
            </a>
          </p>
        </div>
